...
<script>
	$(function () {
		//利用jQuery AJAX加载课程数据
		$.ajax({
			url: '/Teacher/toeditteacher',//请求URL
			data: {tid: '${param.tid}'},//请求参数
			type: 'POST',//请求方式
			...
			success: function (data) {
				...
				//设置课程数据
				$('input[name="tname"]').val(teacher.tname);
				$('input[name="tno"]').val(teacher.tno);
				$('input[name="tpw"]').val(teacher.tpw);
				$('input[name="taddtime"]').val(teacher.taddtime);
				$('input[name="tupdatetime"]').val(teacher.tupdatetime);
				$('input[name="taddperson"]').val(teacher.taddperson);
				$('input[name="tupdateperson"]').val(teacher.tupdateperson);
			},
...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/Teacher/editteacher"  method="post">
				<!-- 正文区域 -->
				<section class="content"> <!--添加课程信息-->

				<div class="panel panel-default">
					<div class="panel-heading">教师号:${param.tid}</div>
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="tpw"
								   >
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="tupdateperson"
								   required>
						</div>
