			...
			<form action="#"
				...
				<div class="row data-type" align="center">
					<c:choose>
						...
						<c:otherwise>
							<c:forEach items="${requestScope.page.rows}" var="teacher">
								<tr>
								...
								<div class="col-lg-2 data">
									<td><fmt:formatDate value="${teacher.taddtime}" pattern="yyyy-MM-dd"/></td>
								</div>
								<div class="col-lg-2 data"	>
									<td><fmt:formatDate value="${teacher.tupdatetime}" pattern="yyyy-MM-dd"/></td>
								</div>
								<div class="col-lg-1 data">
									<td>${teacher.taddperson}</td>
								</div>
								<div class="col-lg-1 data">
									<td>${teacher.tupdateperson}</td>
								</div>
								<div class="col-lg-2 data" >
									<td>
										<a href="#" onclick="deleteTeacher(${teacher.tid})">删除</a>
										<a href="/admin/teacher-update.jsp?tid=${teacher.tid}">修改</a>
									</td>
								</div>
								</tr>
							</c:forEach>
				...
				<script>
					...
					function deleteTeacher(tid) {
						if (window.confirm('确定要删除吗?')) {
							window.location.href = '/Teacher/deleteteacher?tid='+ tid;
						}
					}
