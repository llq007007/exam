...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_asc">专业代号</th>
										<th class="sorting_desc">专业名称</th>
										<th class="sorting_asc sorting_asc_disabled">添加时间</th>
										<th class="sorting_desc sorting_desc_disabled">修改时间</th>
										<th class="sorting">添加人</th>
										<th class="text-center sorting">修改人</th>
								...
								<tbody>
									...
									<c:forEach items="${zyList}" var="zy">
										...
										<tr>
											...
											<td>${zy.zyno }</td>
											<td>${zy.zyname }</td>
											<td><fmt:formatDate value="${zy.zyaddtime }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
											<td><fmt:formatDate value="${zy.zyupdatetime }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
											<td>${zy.zyaddperson }</td>
											<td>${zy.zyupdateperson}</td>
											<td>
												<div class="btn-group">
		...
		<script>
			 ...
			 * @param empName
			 */
			function deleteZy(zyid,zyname ) {
				if (window.confirm('确定要删除【' + zyname + '】吗?')) {
					window.location.href = '/zy/delete?zyid=' + zyid;
				}
			}
