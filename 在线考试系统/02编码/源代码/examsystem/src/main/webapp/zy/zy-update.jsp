...
<link rel="stylesheet"
	...
	<script>
		$(function () {
			...
			$.ajax({
				url: '/zy/load_one',//请求URL
				data: {zyid: '${param.zyid}'},//请求参数
				type: 'POST',//请求方式
				...
				success: function (data) {
					...
					//设置员工数据
					$('input[name="zyid"]').val(zy.zyid);
					$('input[name="zyno"]').val(zy.zyno);
					$('input[name="zyname"]').val(zy.zyname);
					$('input[name="zyaddtime"]').val(zy.zyaddtime);
					$('input[name="zyupdatetime"]').val(zy.zyupdatetime);
					$('input[name="zyaddperson"]').val(zy.zyaddperson);
					$('input[name="zyupdateperson"]').val(zy.zyupdateperson);
...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/zy/update"
				method="post">
				<!-- 正文区域 -->
				<section class="content"> <!--修改专业信息-->

				<div class="panel panel-default">
					<div class="panel-heading">专业号${param.zyid}</div>
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="zyupdateperson">
						</div>
				...
				<div class="box-tools text-center">
					...
					<button type="reset" class="btn bg-maroon">重新填写</button>
