                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" name="tid"
                               placeholder="专业ID" value="${requestScope.teacher.tid}" readonly>
                    </div>

                    <div class="col-md-2 title">教师编号</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" name="tno"
                               placeholder="专业ID" value="${requestScope.teacher.tno}" readonly>
                    </div>

                    <div class="col-md-2 title">教师姓名</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" name="tname"
                               placeholder="姓名" value="${requestScope.teacher.tname}" readonly>
                    </div>
