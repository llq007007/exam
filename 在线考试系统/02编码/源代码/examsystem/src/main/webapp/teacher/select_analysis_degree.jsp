...
<div class="wrapper">
    ...
    <div class="content-wrapper" style="height: 1850px">
        <div class="col-md-2 title">选择需要查询的试卷名称</div>
        <div class="col-md-4 data">
            ...
            <c:if test="${requestScope.scoreList!=null}">
                ...
                共查询到:<span style="color: #1f33ff">${fn:length(requestScope.scoreList)}</span>条记录
            </c:if>
        </div>
    </div>
