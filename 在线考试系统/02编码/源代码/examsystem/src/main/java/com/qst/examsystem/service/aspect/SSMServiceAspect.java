package com.qst.examsystem.service.aspect;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.StrUtil;
import com.alibaba.fastjson.JSON;
import com.qst.examsystem.mapper.ServiceLogMonitorMapper;
...
public class SSMServiceAspect {
     ...
     */
    @Pointcut("execution(* com.qst.examsystem.service..*ServiceImpl.*(..))")
